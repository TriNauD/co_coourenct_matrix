...
public class WordConcurrnce {
    ...
    public static class WordConcurrenceMapper extends
            Mapper<Text, BytesWritable, co_coourenct_matrix.WordPair, IntWritable> {
    ...
    public static class WordConcurrenceReducer extends
            Reducer<co_coourenct_matrix.WordPair, IntWritable, co_coourenct_matrix.WordPair, IntWritable> {
        @Override
        public void reduce(co_coourenct_matrix.WordPair wordPair, Iterable<IntWritable> frequence,
